...
{Primary Entry point to conduct the export to a file of any of the approved formats}
...
{Determine the file type of a given file name through the extension}
...
{Export the data to a spreadsheet. Either Excel or OpenDocument depending on the file type.}
